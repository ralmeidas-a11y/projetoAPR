      ...
      <div className="ml-10 flex-grow flex flex-col">
        ...
        <div className="flex gap-2 items-stretch mt-2">
          <div className="border border-black w-[70%] flex flex-col">
            <div className="bg-slate-200 px-3 py-0.5 border-b border-black">
              <span className="text-[10px] font-black uppercase text-slate-800 tracking-wider">Redes Planificadas:</span>
            </div>
              ...
              <table className="w-full text-center border-collapse text-[8px] font-black table-auto h-full">
                <thead className="bg-white border-b border-black">
                  <tr className="divide-x divide-black uppercase">
                    <th className="py-1 px-1">Extensão (m)</th>
                    <th className="py-1 px-1">Ø (mm)</th>
                    <th className="py-1 px-1">Material</th>
                    <th className="py-1 px-1">Pressão</th>
                    <th className="py-1 px-1">Gás</th>
                    <th className="py-1 px-1">Válvulas</th>
                  </tr>
                </thead>
                <tbody>
                  {(data.plannedExtensions && data.plannedExtensions.length > 0) ? data.plannedExtensions.map((ext, idx) => (
                    <tr key={idx} className="divide-x divide-black uppercase border-b border-black/10">
                      <td className="py-2 px-1">{ext.extension}</td>
                      <td className="py-2 px-1">{ext.diameter}</td>
                      <td className="py-2 px-1">{ext.material}</td>
                      <td className="py-2 px-1">{ext.pressure}</td>
                      <td className="py-2 px-1">{ext.gasType}</td>
                      <td className="py-2 px-1">{ext.valves}</td>
                    </tr>
                  )) : (
              ...
              <tbody>
                ...
                <tr className="bg-white border-b border-black h-6">
                  <td colSpan={2} className="py-0.5 px-1 text-blue-700">
                    {(data as any).regSizingFlow ? formatCurrency((data as any).regSizingFlow) : ''} m³/h
                  </td>
                </tr>
                <tr className="bg-slate-200 border-b border-black">
                ...
                <tr className="bg-white h-6">
                  <td colSpan={2} className="py-0.5 px-1 text-blue-700">
                    {(data as any).regSizingFutureFlow ? formatCurrency((data as any).regSizingFutureFlow) : ''} m³/h
                  </td>
                </tr>
              </tbody>
            </table>
