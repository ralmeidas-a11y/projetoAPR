      ...
      <div className="ml-10 space-y-4 flex-grow flex flex-col">
        <div className="border border-black">
          ...
          <div className="p-3">
            ...
            {(data.numClientsRes || data.totalFlowRes || data.numClientsCom || data.totalFlowCom) ? (
                  ...
                  <tr className="divide-x divide-black h-8 text-center" style={{ textAlign: 'center' }}>
                    <td className="p-0" style={{ verticalAlign: 'middle', textAlign: 'center' }}>
                      <table style={{ width: '100%', height: '100%', borderCollapse: 'collapse' }}>
                        <tbody>
                          <tr>
                            <td className="w-1/2 p-0 text-center border-r border-black">{data.numClientsRes || 0}</td>
                            <td className="w-1/2 p-0 text-center">{formatCurrency(data.totalFlowRes)} m³/h</td>
                          </tr>
                        </tbody>
                      </table>
                    </td>
                    <td className="p-0" style={{ verticalAlign: 'middle', textAlign: 'center' }}>
                      <table style={{ width: '100%', height: '100%', borderCollapse: 'collapse' }}>
                        <tbody>
                          <tr>
                            <td className="w-1/2 p-0 text-center border-r border-black">{data.numClientsCom || 0}</td>
                            <td className="w-1/2 p-0 text-center">{formatCurrency(data.totalFlowCom)} m³/h</td>
                          </tr>
                        </tbody>
                      </table>
                    </td>
