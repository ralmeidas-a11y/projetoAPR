              ...
              <table className="w-full text-center divide-y divide-black divide-x border-collapse text-[10px] font-black table-auto">
                <thead className="bg-[#f0f0f0]">
                  <tr className="divide-x divide-black">
                    <th className="w-1/2 py-1 text-center">Vazão Solicitada (m³/h)</th>
                    <th className="w-1/2 py-1 text-center">Pressão Mínima Solicitada (bar)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-black">
                  <tr className="divide-x divide-black h-8">
                    <td className="py-1 text-center">{(data as any).peakFlow || (data as any).totalPredictedFlow || (data as any).informedFlow ? formatCurrency((data as any).peakFlow || (data as any).totalPredictedFlow || (data as any).informedFlow) : ' - '}</td>
                    <td className="py-1 text-center">{data.minPressure || data.technicalMetadata?.minPressure || ' - '}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <tbody>
                <tr className="bg-slate-200 border-b border-black">
                  <td colSpan={2} className="py-1 px-1">
                    ERM Distrital<br />Projetada
                  </td>
                </tr>
                <tr className="bg-slate-200 border-b border-black">
                  <td colSpan={2} className="py-0.5 px-1">
                    Pressões
                  </td>
                </tr>
                <tr className="bg-slate-200 border-b border-black divide-x divide-black">
                ...
                <tr className="bg-white border-b border-black h-6">
                  <td colSpan={2} className="py-0.5 px-1 text-blue-700">
                    {data.regSizingFlow ? formatCurrency(data.regSizingFlow) : ''} m³/h
                  </td>
                </tr>
                <tr className="bg-slate-200 border-b border-black">
                  <td colSpan={2} className="py-0.5 px-1">
                ...
                <tr className="bg-white h-6">
                  <td colSpan={2} className="py-0.5 px-1 text-blue-700">
                    {data.regSizingFutureFlow ? formatCurrency(data.regSizingFutureFlow) : ''} m³/h
                  </td>
                </tr>
              </tbody>
            </table>
