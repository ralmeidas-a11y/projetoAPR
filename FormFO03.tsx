...
export const FormFO03: React.FC<FormFO03Props> = ({ data, onChange }) => {
  ...
  return (
    <div className="space-y-8" style={{ fontSize: '10pt', fontFamily: 'Arial, sans-serif' }}>
      ...
      <section>
        ...
        <div className="p-4 border border-slate-200 rounded-b space-y-4 bg-white">
          ...
          >
            ...
            {/* Instruction Box - Visible only on Hover */}
            <div className={`
              absolute left-0 bottom-full mb-2 w-full p-3 bg-white border border-slate-200 rounded-md shadow-xl transition-all duration-300 z-10
              ${showTooltip ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none'}
            `}>
              <h5 className="font-bold text-[#004080] text-[10pt] mb-1">Localização em Coordenadas</h5>
              <p className="text-[9pt] text-slate-600 leading-snug italic">
                Anexar planta georreferenciada de localização do empreendimento com a indicação aproximada do ponto de entrega à UTE com coordenadas UTM. Preferencialmente associada à imagem por satélite.
              </p>
              {/* Tooltip Arrow */}
            ...
            <textarea 
              ...
              rows={3} 
              className="w-full p-2 border border-slate-200 rounded outline-none font-normal bg-white" 
              placeholder="Descreva a localização georeferenciada ou indique se anexou o arquivo..." 
            />
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <section>
          ...
          <div className="p-4 border border-slate-200 rounded-b bg-white space-y-3">
             <div className="flex items-center gap-2">
                <label className="text-[9px] font-bold text-[#004080] flex-grow">Pressão Máxima UTE :</label>
             ...
             <div className="flex items-center gap-2">
                <label className="text-[9px] font-bold text-[#004080] flex-grow">Pressão Mínima UTE :</label>
                <div className="flex items-center gap-2 w-32">
             ...
             <div className="flex items-center gap-2">
                <label className="text-[9px] font-bold text-[#004080] flex-grow">Vazão Instantânea :</label>
                <div className="flex items-center gap-2 w-32">
                   ...
                   <span className="text-[8px] font-bold text-slate-400 w-8">Nm³/h (2)</span>
                </div>
             </div>
             <div className="flex items-center gap-2">
                <label className="text-[9px] font-bold text-[#004080] flex-grow">QDC</label>
                <div className="flex items-center gap-2 w-32">
        ...
        <section>
          ...
          <div className="p-4 border border-slate-200 rounded-b bg-white space-y-3">
             <div className="flex items-center gap-2">
                <label className="text-[9px] font-bold text-[#004080] flex-grow">Pressão Máxima UPGN :</label>
                <div className="flex items-center gap-2 w-32">
             ...
             <div className="flex items-center gap-2">
                <label className="text-[9px] font-bold text-[#004080] flex-grow">Pressão Mínima UPGN :</label>
                <div className="flex items-center gap-2 w-32">
